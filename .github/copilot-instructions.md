...
This adapter retrieves weather warnings from the DWD and ZAMG, processes them and provides users with a variety of options for receiving notifications.
